...
class IndeedSpider(Spider):
    ...
    custom_settings = {
        'ITEM_PIPELINES': {
            'pipelines.IndeedPipeline': 300,
            'pipelines.MongoDBPipeline': 400
        }
    }

    def __init__(self, job_query_id, url=None, num_results=None):
        """
        Handle arguments passed in by the caller.
        :param job_query_id: The id in db corresponding to the job_query.
        :param url: Desired url to start scraping.
        :param num_results: Desired number of results to process.
        """
        self.job_query_id = job_query_id
        self.start_url = url
    ...
    def setup_job_info(self, job_row):
        ...
        # Set job_query_id
        job_info['job_query_id'] = self.job_query_id
